    ...
    internal fun writeShim(routePath: String, routes: List<RouteDef>, outDir: File, template: String, srcRoot: File) {
        ...
        routes.forEachIndexed { index, def ->
            ...
            def.errorResponses.forEach { (code, type) ->
                ...
                methodHandlersBlock.append("\t\t\t\tTatara.Api.ResponseWriter:WriteError(oResponse, $code, errCustom:GetMessage(1)).\r\n")
                methodHandlersBlock.append("\t\t\t\tRETURN 0.\r\n")
                methodHandlersBlock.append("\t\t\tEND.\r\n")
            }
            ...
            methodHandlersBlock.append("\t\t\t\tTatara.Api.ResponseWriter:WriteError(oResponse, 500, errApp:GetMessage(1)).\r\n")
            methodHandlersBlock.append("\t\t\t\tRETURN 0.\r\n")
            methodHandlersBlock.append("\t\t\tEND.\r\n")
            methodHandlersBlock.append("\t\tEND.\r\n")
            methodHandlersBlock.append("\r\n")
